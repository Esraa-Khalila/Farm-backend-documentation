            ...
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <span class="d-block info__title">Getting Started</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_2" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                        ...
                        <span class="d-block info__title">Pricing Plans</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        ...
                        <span class="d-block info__title">Sales Question</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_4" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 412.72 412.72" style="enable-background:new 0 0 412.72 412.72;" xml:space="preserve">
                            <g>
                                <g>
                        ...
                        <span class="d-block info__title">Usage Guides</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" id="Capa_5" enable-background="new 0 0 511.996 511.996" viewBox="0 0 511.996 511.996" xmlns="http://www.w3.org/2000/svg">
                            <g id="XMLID_1609_">
                                <g id="XMLID_564_">
                                    ...
                                    <path id="XMLID_1039_" d="m211.13 149.4c2.63 0 5.21-1.07 7.07-2.93s2.93-4.44 2.93-7.07-1.07-5.21-2.93-7.07c-1.86-1.859-4.43-2.93-7.07-2.93-2.63 0-5.21 1.07-7.07 2.93s-2.93 4.44-2.93 7.07 1.07 5.21 2.93 7.07c1.86 1.859 4.44 2.93 7.07 2.93z"></path>
                                </g>
                            </g>
                        </svg>
                        <span class="d-block info__title">Information</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_6" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 480.1 480.1" style="enable-background:new 0 0 480.1 480.1;" xml:space="preserve">
                                <g>
                                    <g>
                        ...
                        <span class="d-block info__title">Transactions</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_7" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 507.996 507.996" style="enable-background:new 0 0 507.996 507.996;" xml:space="preserve">
                            <g>
                                <g>
                                    <rect x="49.2" y="225.488" width="81.9" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <rect x="49.2" y="274.688" width="122.9" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <rect x="49.2" y="323.888" width="295" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <rect x="49.2" y="372.988" width="49.2" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <rect x="131.1" y="372.988" width="49.2" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                                    <rect x="213.1" y="372.988" width="49.2" height="16.4"></rect>
                                </g>
                            </g>
                            <g>
                                <g>
                        ...
                        <span class="d-block info__title">Card</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
            <div class="col-lg-3 responsive-column">
                <div class="icon-box faq-icon-box">
                    <a href="#" class="d-block">
                        <svg class="info-svg" version="1.1" id="Capa_8" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 511.997 511.997" xml:space="preserve">
                            <g>
                                <g>
                        ...
                        <span class="d-block info__title">Account</span>
                    </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:10 GMT -->
</html>