                                ...
                                <div class="contact-form-action">
                                    <form method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="btn-box">
                                                    <button class="theme-btn" type="submit"><a href="payment-complete.html">Confirm Booking</a></button>
                                                </div>
                                            </div><!-- end col-lg-12 -->
                                        </div>
                                    </form>
                                ...
                                <div class="contact-form-action">
                                    <form method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="btn-box">
                                                    <button class="theme-btn" type="submit"> <a href="payment-complete.html">Login Account</a></button>
                                                </div>
                                            </div><!-- end col-lg-12 -->
                                        </div>
                                    </form>
