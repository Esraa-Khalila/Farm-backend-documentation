        ...
        <div class="row">
            <div  class="col-lg-9 mx-auto">
                <div class="listing-header pb-4">
                    ...
                    <p class="font-size-14"><a href="#" class="text-color">Read the complete Farm policy for accommodations.</a></p>
                </div>
                <div class="form-box">
                            ...
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" placeholder="Farm name">
                                    </div>
                                </div>
                            </div><!-- end col-lg-6 -->
                            <div class="col-lg-6 responsive-column">
                            ...
                            <div class="col-lg-6 responsive-column">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="location" placeholder="example: Deadsea">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div  class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="input-box mb-4">
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        <input class="form-control pl-3" type="text" name="day">
                                        <span class="px-2">to</span>
                                        <input class="form-control pl-3" type="text" name="time">
                                    </div>
                                    <div class="custom-checkbox">
                        ...
                        <div  class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="input-box">
                                    ...
                                    <div class="form-group">
                                        <span class="la la-pencil form-icon"></span>
                                        <textarea class="message-control form-control" name='description' placeholder=" "></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
               ...
               {{-- <div class="form-box">
                ...
                <div class="form-box">
                    ...
                    <div class="form-content contact-form-action">
                        <div " class="row">
                            <div class="col-lg-12">
                           <input type='hidden' name="user_id" value="{{ __(Auth::user()->id) }}">
                                <div class="file-upload-wrap">
                                    <input type="file" name="images" class="multi file-upload-input with-preview" multiple maxlength="3">
