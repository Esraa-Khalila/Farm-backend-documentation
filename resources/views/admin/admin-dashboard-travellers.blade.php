...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/admin-dashboard-travellers.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:27 GMT -->
<head>
        ...
        <div class="sidebar-menu-wrap">
            <ul class="sidebar-menu toggle-menu list-items">
                ...
                <li class="page-active">
                    ...
                    <a href="admin-dashboard-travellers.html"><i class="la la-users mr-2"></i>Travellers</a>
                    <ul class="toggle-drop-menu">
                                ...
                                <div class="table-form table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="table-content">
                                                    <a href="admin-dashboard-traveler-detail.html" class="theme-btn theme-btn-small mr-2" data-toggle="tooltip" data-placement="top" title="View"><i class="la la-eye"></i></a>
