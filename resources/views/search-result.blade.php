                ...
                <div class="col-lg-12">
                    <div class="search-result-content">
                        <div class="section-heading">
                            <h2 class="sec__title text-white">Farm Search Result</h2>
                        </div>
                                ...
                                <div class="pt-3 collapse" id="collapseTwo">
                                    ...
                                    <div class="checkbox-wrap padding-top-30px">
                                        ...
                                        <div class="custom-checkbox d-inline-block mr-4">
                                            ...
                                            <label for="activityChb3">Pool</label>
                                        </div>
                                        <div class="custom-checkbox d-inline-block mr-4">
                                            <input type="checkbox" id="activityChb4">
                                            <label for="activityChb4">football stadium</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="btn-box pt-3">
                                <a href="#" class="theme-btn theme-btn-hover-gray" style="background-color:rgb(233,236,239)">Search Now</a>
                            </div>
            ...
            <div class="col-lg-12">
                <div class="filter-wrap margin-bottom-30px">
                    <div class="filter-top pb-4">
                        <h3 class="title font-size-24">Jordan: 20 Farm found</h3>
                    ...
                    <div class="filter-bar d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown-item">
                                            <div class="checkbox-wrap">
                                                <div class="custom-checkbox">
                                                    ...
                                                    <label for="catChb1">zarq</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb2">
                                                    <label for="catChb2">Irbid</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb3">
                                                    <label for="catChb3">Amman</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb4">
                                                    <label for="catChb4">Jersh</label>
                                                </div>
                                            </div>
                                        </div><!-- end dropdown-item -->
                                    </div><!-- end dropdown-menu -->
                                    ...
                                    <div class="dropdown-menu dropdown-menu-wrap">
                                        <div class="dropdown-item">
                                            <div class="checkbox-wrap">
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb1">
                                                    <label for="catChb1">Food & Nightlife</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb2">
                                                    <label for="catChb2">Outdoors</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb3">
                                                    <label for="catChb3">Pool</label>
                                                </div>
                                                <div class="custom-checkbox">
                                                    <input type="checkbox" id="catChb4">
                                                    <label for="catChb4">football stadium</label>
                                                </div>
                                            </div>
                                        </div><!-- end dropdown-item -->
                                    </div><!-- end dropdown-menu -->
                        ...
                        <div class="select-contain">
                            <select >
                                ...
                                <option value="2">New Farm</option>
        ...
        <div class="row">
                ...
                <div class="card-item trending-card">
                    <div class="card-img">
                        <a href="tour-details.html" class="d-block">
                            <img src="images/resize (10).jfif" alt="Destination-img">
                        </a>
                        <span class="badge">Bestseller</span>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">Maldives farms</a></h3>
                        <p class="card-meta">jersh</p>
                        ...
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__num">180.00JD</span>
                            </p>
            ...
            <div class="col-lg-4">
                <div class="card-item trending-card">
                    ...
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">Aqua Villa</a></h3>
                        <p class="card-meta">Deadsea ,jofea</p>
                        <div class="card-rating">
                            <span class="badge text-white">4/5</span>
                            <span class="review__text">Average</span>
                            <span class="rating__text">(40 Reviews)</span>
                        </div>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__num">120.00Jd</span>
                                <span class="price__num before-price color-text-3">100.00Jd</span>
                            </p>
                            <a href="tour-details.html" class="btn-text">View details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card-item trending-card">
                    <div class="card-img">
                        <a href="tour-details.html" class="d-block">
                            <img src="images/resize (20).jfif" alt="Destination-img">
                        </a>
                        <span class="badge">Featured</span>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">Alanya chalet</a></h3>
                        <p class="card-meta">Jersh , hall roman</p>
                        <div class="card-rating">
                            <span class="badge text-white">3.2/5</span>
                            <span class="review__text">Average</span>
                            <span class="rating__text">(30 Reviews)</span>
                        </div>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__num">100.00Jd</span>
                            </p>
                            <a href="tour-details.html" class="btn-text">View details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card-item trending-card">
                    <div class="card-img">
                        <a href="tour-details.html" class="d-block">
                            <img src="images/resize (11).jfif" alt="Destination-img">
                        </a>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">AL-EZZ FARM</a></h3>
                        <p class="card-meta">Mafreq</p>
                        <div class="card-rating">
                            <span class="badge text-white">4.5/5</span>
                            <span class="review__text">Average</span>
                            <span class="rating__text">(20 Reviews)</span>
                        </div>
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__num">125.00Jd</span>
                            </p>
                            <a href="tour-details.html" class="btn-text">View details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="card-item trending-card">
                    <div class="card-img">
                        <a href="tour-details.html" class="d-block">
                            <img src="images/resize (12).jfif" alt="Destination-img">
                        </a>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">Villa Yara</a></h3>
                        <p class="card-meta">Airport Street</p>
                        <div class="card-rating">
            ...
            <div class="col-lg-4">
                <div class="card-item trending-card">
                    <div class="card-img">
                        <a href="tour-details.html" class="d-block">
                            <img src="images/resize (13).jfif" alt="Destination-img">
                        </a>
                        <span class="badge">Featured</span>
                    </div>
                    <div class="card-body">
                        <h3 class="card-title"><a href="tour-details.html">Zaid Alkhaeer Farm</a></h3>
                        <p class="card-meta">Irbid </p>
                        <div class="card-rating">
                        ...
                        <div class="card-price d-flex align-items-center justify-content-between">
                            <p>
                                <span class="price__num">170.00Jd</span>
                            </p>
                            <a href="tour-details.html" class="btn-text">View details<i class="la la-angle-right"></i></a>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="btn-box mt-3 text-center">
                    <button type="button" class=" btn btn1 w-25  "><i class="la la-refresh mr-1"></i>Load More</button>
                    <p class="font-size-13 pt-2">Showing 1 - 6 of 20 farms</p>
                </div><!-- end btn-box -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
    </div><!-- end container -->
...
<!-- Mirrored from techydevs.com/demos/themes/html/trizen-demo/trizen/activity-search-result.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 26 Jun 2022 09:48:16 GMT -->
</html>